...
const ITEM_ICONS = {
  // Programming
  "Python": { iconName: "FaPython", color: "text-blue-600" },
  "Java": { iconName: "FaJava", color: "text-red-400" },
  "JavaScript": { iconName: "FaJs", color: "text-yellow-400" },
  "C++": { text: "C++", color: "text-blue-500" },
  "C Programming": { text: "C", color: "text-blue-500" },
  "SQL": { iconName: "FaDatabase", color: "text-blue-300" },
  "PHP": { text: "PHP", color: "text-purple-500" },
  "TypeScript": { iconName: "SiTypescript", color: "text-blue-700" },

  // Core Subjects
  "Data Structures & Algorithms": { iconName: "FaCode", color: "text-purple-400" },
  "DBMS": { iconName: "FaDatabase", color: "text-blue-500" },
  "Operating System": { iconName: "FaServer", color: "text-gray-500" },
  "Computer Networks": { iconName: "FaServer", color: "text-green-400" },
  "OOPs Concepts": { iconName: "FaCode", color: "text-red-500" },
  "Software Engineering": { iconName: "FaCode", color: "text-green-600" },
  "Web & Internet Technologies": { iconName: "FaCode", color: "text-blue-400" },
  "Computer Organization & Architecture": { iconName: "FaServer", color: "text-indigo-500" },

  // Government Exams
  "SSC CGL": { iconName: "FaAngleRight", color: "text-blue-500" },
  "SSC CHSL": { iconName: "FaAngleRight", color: "text-blue-500" },
  "SSC GD": { iconName: "FaAngleRight", color: "text-blue-500" },
  "SSC MTS": { iconName: "FaAngleRight", color: "text-blue-500" },
  "SSC Stenographer": { iconName: "FaAngleRight", color: "text-blue-500" },

  // Special items
  "Coming Soon": { iconName: "FaAngleRight", color: "text-blue-500" },
  "view more →": { iconName: "FaAngleRight", color: "text-blue-500" }
};
...
const CategoryDropdown = ({ isMobileView }) => {
  ...
  const getItemIcon = (item) => {
    const iconData = ITEM_ICONS[item] || { iconName: "FaAngleRight", color: "text-blue-500" };
    ...
    if (iconData.iconName) {
      const IconComponent = {
        ...
        SiTypescript,
        FaAngleRight
      }[iconData.iconName] || FaAngleRight;

      return <IconComponent className={`${iconData.color || "text-blue-500"} mr-2`} />;
    }
