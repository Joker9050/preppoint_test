    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
          <button className="px-6 py-2.5 sm:px-8 sm:py-3 text-sm sm:text-base font-medium bg-[#0a63b0] hover:bg-[white] hover:text-[#0a63b0] text-white rounded-lg shadow-md transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
            Start Learning Now
