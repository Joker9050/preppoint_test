  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'http://your-api-endpoint/auth/register',
        { name, email, password },
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="hidden md:flex w-1/3 bg-gradient-to-b from-[#0a63b0] to-indigo-700 p-8 flex-col justify-center text-white">
        <div className="max-w-xs mx-auto">
          <h1 className="text-4xl font-bold mb-6">Become a W3Schooler</h1>
      ...
      <div className="w-full md:w-2/3 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button 
            onClick={() => navigate('/')}
            className="mb-6 flex items-center text-[#0a63b0] hover:text-blue-800 text-sm font-medium"
          >
