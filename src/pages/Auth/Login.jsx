            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  <Link href="/register" className="text-[#0a63b0] hover:underline font-medium">Sign up</Link>
                </p>
                ...
                <form className="space-y-5" onSubmit={handleSubmit} noValidate>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className={`w-full px-4 pr-12 py-2.5 text-sm rounded-lg border ${
                      ...
                      <button
                        type="button"
                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none bg-white rounded-r-lg px-2"
                  ...
                  <div className="flex items-center justify-end">
                    <Link href="/forgot-password" className="text-sm text-[#0a63b0] hover:underline font-medium">
                      Forgot password?
                    </Link>
                  </div>
